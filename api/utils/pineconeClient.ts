/**
 * Pinecone Vector Database Client for Edge Functions
 *
 * Provides edge-runtime compatible client for FAQ vector similarity search.
 * Uses OpenAI text-embedding-3-small embeddings (1536 dimensions) with cosine similarity.
 *
 * @module api/utils/pineconeClient
